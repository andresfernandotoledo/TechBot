...
MIBS = {
    "system": {
        "label": "💻 Sistema",
        "oids": {
            "sysDescr":       {"oid": "1.3.6.1.2.1.1.1.0", "desc": "Descripción del dispositivo"},
            "sysObjectID":    {"oid": "1.3.6.1.2.1.1.2.0", "desc": "OID del fabricante/modelo"},
            "sysUpTime":      {"oid": "1.3.6.1.2.1.1.3.0", "desc": "Tiempo desde último reinicio"},
            "sysName":        {"oid": "1.3.6.1.2.1.1.5.0", "desc": "Nombre del dispositivo"},
            "sysContact":     {"oid": "1.3.6.1.2.1.1.4.0", "desc": "Contacto del administrador"},
            "sysLocation":    {"oid": "1.3.6.1.2.1.1.6.0", "desc": "Ubicación física"},
            "sysServices":    {"oid": "1.3.6.1.2.1.1.7.0", "desc": "Servicios que ofrece (bitmask)"},
        }
    },
    "interfaces": {
        "label": "🔌 Interfaces",
        "oids": {
            "ifNumber":       {"oid": "1.3.6.1.2.1.2.1.0", "desc": "Cantidad de interfaces"},
            "ifDescr":        {"oid": "1.3.6.1.2.1.2.2.1.2", "desc": "Descripción de cada interfaz"},
            "ifType":         {"oid": "1.3.6.1.2.1.2.2.1.3", "desc": "Tipo (ethernet, wifi, etc)"},
            "ifMtu":          {"oid": "1.3.6.1.2.1.2.2.1.4", "desc": "MTU de cada interfaz"},
            "ifSpeed":        {"oid": "1.3.6.1.2.1.2.2.1.5", "desc": "Velocidad en bps"},
            "ifPhysAddress":  {"oid": "1.3.6.1.2.1.2.2.1.6", "desc": "Dirección MAC"},
            "ifAdminStatus":  {"oid": "1.3.6.1.2.1.2.2.1.7", "desc": "Estado administrativo (up/down)"},
            "ifOperStatus":   {"oid": "1.3.6.1.2.1.2.2.1.8", "desc": "Estado operativo (up/down)"},
            "ifInOctets":     {"oid": "1.3.6.1.2.1.2.2.1.10", "desc": "Octetos recibidos"},
            "ifOutOctets":    {"oid": "1.3.6.1.2.1.2.2.1.16", "desc": "Octetos enviados"},
            "ifInErrors":     {"oid": "1.3.6.1.2.1.2.2.1.14", "desc": "Errores de recepción"},
            "ifOutErrors":    {"oid": "1.3.6.1.2.1.2.2.1.20", "desc": "Errores de transmisión"},
        }
    },
    "ip": {
        "label": "🌐 Red/IP",
        "oids": {
            "ipForwarding":   {"oid": "1.3.6.1.2.1.4.1.0", "desc": "IP forwarding habilitado"},
            "ipDefaultTTL":   {"oid": "1.3.6.1.2.1.4.2.0", "desc": "TTL por defecto"},
            "ipInReceives":   {"oid": "1.3.6.1.2.1.4.3.0", "desc": "Paquetes IP recibidos"},
            "ipInHdrErrors":  {"oid": "1.3.6.1.2.1.4.4.0", "desc": "Errores en cabecera IP"},
            "ipOutRequests":  {"oid": "1.3.6.1.2.1.4.10.0", "desc": "Paquetes IP enviados"},
            "ipNetToMediaPhysAddress": {"oid": "1.3.6.1.2.1.4.22.1.2", "desc": "MAC de tabla ARP"},
            "ipNetToMediaNetAddress":  {"oid": "1.3.6.1.2.1.4.22.1.3", "desc": "IP de tabla ARP"},
        }
    },
    "bridge": {
        "label": "🔗 Bridge/Switch",
        "oids": {
            "dot1dBaseBridgeAddress":    {"oid": "1.3.6.1.2.1.17.1.1.0", "desc": "MAC base del bridge"},
            "dot1dBaseNumPorts":         {"oid": "1.3.6.1.2.1.17.1.2.0", "desc": "Puertos del bridge"},
            "dot1dTpFdbAddress":         {"oid": "1.3.6.1.2.1.17.4.3.1.1", "desc": "Direcciones MAC (tabla FDB)"},
            "dot1dTpFdbPort":            {"oid": "1.3.6.1.2.1.17.4.3.1.2", "desc": "Puerto asociado en FDB"},
            "dot1dStpTopChanges":        {"oid": "1.3.6.1.2.1.17.2.1.0", "desc": "Cambios de topología STP"},
        }
    },
    "storage": {
        "label": "💾 Almacenamiento",
        "oids": {
            "hrStorageDescr":  {"oid": "1.3.6.1.2.1.25.2.3.1.3", "desc": "Descripción del almacenamiento"},
            "hrStorageSize":   {"oid": "1.3.6.1.2.1.25.2.3.1.5", "desc": "Tamaño total en KB"},
            "hrStorageUsed":   {"oid": "1.3.6.1.2.1.25.2.3.1.6", "desc": "Espacio usado en KB"},
            "hrStorageAllocationUnits": {"oid": "1.3.6.1.2.1.25.2.3.1.4", "desc": "Tamaño de unidad de asignación"},
        }
    },
    "memory": {
        "label": "🧠 Memoria/Sistema",
        "oids": {
            "hrSystemUptime":  {"oid": "1.3.6.1.2.1.25.1.1.0", "desc": "Tiempo activo del sistema"},
            "hrSystemNumUsers": {"oid": "1.3.6.1.2.1.25.1.5.0", "desc": "Usuarios conectados"},
            "hrSystemProcesses": {"oid": "1.3.6.1.2.1.25.1.6.0", "desc": "Procesos en ejecución"},
            "hrDeviceDescr":   {"oid": "1.3.6.1.2.1.25.3.2.1.3", "desc": "Descripción de dispositivos"},
        }
    },
    "tcp": {
        "label": "🔗 TCP/UDP",
        "oids": {
            "tcpRtoAlgorithm": {"oid": "1.3.6.1.2.1.6.1.0", "desc": "Algoritmo RTO"},
            "tcpRtoMin":       {"oid": "1.3.6.1.2.1.6.2.0", "desc": "RTO mínimo (ms)"},
            "tcpRtoMax":       {"oid": "1.3.6.1.2.1.6.3.0", "desc": "RTO máximo (ms)"},
            "tcpMaxConn":      {"oid": "1.3.6.1.2.1.6.4.0", "desc": "Máximo de conexiones"},
            "tcpActiveOpens":  {"oid": "1.3.6.1.2.1.6.5.0", "desc": "Conexiones TCP activas"},
            "tcpPassiveOpens": {"oid": "1.3.6.1.2.1.6.6.0", "desc": "Conexiones TCP pasivas"},
            "tcpInSegs":       {"oid": "1.3.6.1.2.1.6.10.0", "desc": "Segmentos TCP recibidos"},
            "tcpOutSegs":      {"oid": "1.3.6.1.2.1.6.11.0", "desc": "Segmentos TCP enviados"},
            "tcpCurrEstab":    {"oid": "1.3.6.1.2.1.6.9.0", "desc": "Conexiones establecidas"},
            "udpInDatagrams":  {"oid": "1.3.6.1.2.1.7.1.0", "desc": "Datagramas UDP recibidos"},
            "udpOutDatagrams": {"oid": "1.3.6.1.2.1.7.2.0", "desc": "Datagramas UDP enviados"},
            "udpNoPorts":      {"oid": "1.3.6.1.2.1.7.3.0", "desc": "UDP sin puerto destino"},
        }
    },
    "snmp_stats": {
        "label": "📊 Estadísticas SNMP",
        "oids": {
            "snmpInPkts":            {"oid": "1.3.6.1.2.1.11.1.0", "desc": "Paquetes SNMP recibidos"},
            "snmpOutPkts":           {"oid": "1.3.6.1.2.1.11.2.0", "desc": "Paquetes SNMP enviados"},
            "snmpInBadVersions":     {"oid": "1.3.6.1.2.1.11.3.0", "desc": "Versiones SNMP incorrectas"},
            "snmpInBadCommunityNames": {"oid": "1.3.6.1.2.1.11.4.0", "desc": "Community strings incorrectas"},
            "snmpInASNParseErrs":    {"oid": "1.3.6.1.2.1.11.5.0", "desc": "Errores de parseo ASN.1"},
            "snmpInTotalReqVars":    {"oid": "1.3.6.1.2.1.11.13.0", "desc": "Variables solicitadas"},
            "snmpInTotalSetVars":    {"oid": "1.3.6.1.2.1.11.14.0", "desc": "Variables seteadas"},
            "snmpInGetRequests":     {"oid": "1.3.6.1.2.1.11.16.0", "desc": "GET requests recibidos"},
            "snmpInGetNexts":        {"oid": "1.3.6.1.2.1.11.17.0", "desc": "GET-NEXT requests recibidos"},
            "snmpInSetRequests":     {"oid": "1.3.6.1.2.1.11.18.0", "desc": "SET requests recibidos"},
            "snmpEnableAuthenTraps": {"oid": "1.3.6.1.2.1.11.30.0", "desc": "Traps de autenticación habilitados"},
        }
    },
}
